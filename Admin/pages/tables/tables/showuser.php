...
function convertToWebPath($filesystemPath)
{
    ...
    $baseURL = '../../../../Community-management-ajkAHKsystem/';
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            include "../../../connect.php";
                                            $query = "SELECT u.id,u.name, u.username, u.gender, u.dob, u.contactno, u.address,u.email, u.caste_certificate, u.status, u.role,
                                                     c.name AS city_name
                                                    FROM 
                                                        tbl_user u
                                                    JOIN 
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><a target="_blank" href="../../../<?php echo $row["caste_certificate"]; ?>">Click here</a></td>

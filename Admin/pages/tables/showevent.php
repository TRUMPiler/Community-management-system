                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <?php 
                                                 include "../../../connect.php";
                                                $query = "select s.id,u.name,a.name,s.adhar_card_image,s.status,s.school_university_name,s.previous_year_marksheet, s.current_year_std,s.pan_card_no_father,s.pan_card_no_mother,s.occupation_father,s.occupation_mother,s.father_income,s.mother_income,s.bank_name,s.bank_ifsc_code,s.account_no,s.income_certificate,s. from tbl_donation d join  tbl_user u on d.uid=u.id";

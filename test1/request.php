...
{
    echo "<script>alert('role not set');window.location='index.php';</script>";
}
if(isset($_SESSION["role"]) && $_SESSION["role"]=="cMajor")
{
    echo "<script>alert('Community major cannot make any more requests');window.location='index.php';</script>";
}
if(isset($_SESSION["role"]) && $_SESSION["role"]!="Member")
{
    echo "<script>alert('Unauthorised Page');window.location='index.php';</script>";
}
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 align-self-center">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="contact" class="requestGG">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h2>REQUEST FORM</h2>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset>
                                            ...
                                            <?php 
                                            if(isset($_SESSION["role"])&&$_SESSION["role"]=="cMember")
                                            {
                                            ?>    
                                            ...
                                            else
                                            {
                                                ?>
                                                <option value="cMajor">Cmajor</option>
                                                <!-- <option value="cMember">Cmember</option> -->
                                                <?php
                                            }
                                            ?>
                                            </select>
                  ...
                  <!-- <div class="col-lg-12"></div>
                                    <div class="col-lg-4">
                                        <fieldset><a href="sendotp.php"> Forget Password </a><br></fieldset>
                                        <br>
                                        <fieldset><a href="changepassword.php"> Change Password </a></fieldset>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
<br>                                        <fieldset>
                                            <button type="submit" name="login" id="form-submit" class="button">LOGIN</button>
                                        </fieldset>
                                    </div>

          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <a href="announcement-details.php"><img src="assets/images/single-meeting.jpg" alt=""></a>
                </div>
                <div class="down-content">
                  <a href="announcement-details.php"><h4>Online Teaching and Learning Tools</h4></a>
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="announcement.php">Back To Announcement List</a>
              </div>
            </div>
          </div>
        </div>

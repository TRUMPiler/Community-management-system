                        ...
                        <form id="contact" class="GG" action="#" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset>
                                            <input name="name" type="text" id="name" minlength="2" placeholder="Name" required>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset>
                                            <input name="capacity" type="number" id="capacity" placeholder="Capacity" required>
                                            <div id="capacity-error" class="error"></div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset>
                                            <input name="rent" type="number" id="rent" placeholder="Rent" required>
                                            <div id="rent-error" class="error"></div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <fieldset>
                                            <input name="status" type="text" id="status" placeholder="Status" required>
...
<script>
    ...
    $('.GG').on('submit', function(e){
        ...
        let valid = true;
          ...
          const addressRegex = /^[A-Z0-9\s,.'-]{5,}$/i;
